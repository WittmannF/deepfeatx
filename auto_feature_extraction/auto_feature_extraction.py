# AUTOGENERATED! DO NOT EDIT! File to edit: 00_auto_feature_extraction.ipynb (unless otherwise specified).

__all__ = ['download_dataset', 'ImageFeatureExtractor', 'PROJECT_FOLDER', 'DATA_PATH', 'DOGSCATS', 'DOG_BREED_URL',
           'ZIP_FILENAME', 'PETS', 'TRAIN_PATH', 'VALID_PATH']
